    ...
    <div class="connectRegister-Wrapper">
        <div class="connect-block">
            ...
            <form class="connect" method="POST" action="index.php?action=connect">
                <label for="user-name">Nom d'utilisateur :</label><input type="text" name="user-name"
                                                                         id="user-name"><br/>
                <label for="user-pass">Votre mot de passe :</label><input type="password" name="user-pass"
                                                                          id="user-pass"><br/>
